...
* e.g. node ./insertDefaultData.js dev
*
***********************************************************************/
insertDefaultData();
...
//	teamTableFunctions.insertTeamTableData(ddb, TEAM_TABLE, subdomainPrefix);
	configsTableFunctions.insertConfigsTableData(ddbdc, subdomainPrefix);	
	teamTableFunctions.insertTeamTableData(ddbdc, subdomainPrefix);
}
